package com.fh.controller.erp.level;
...
public class LevelController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		page.setPd(pd);
		List<PageData>	varList = levelService.list(page);	//列出Level列表
		mv.setViewName("erp/level/level_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("erp/level/level_edit");
	...
	public ModelAndView goEdit()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = levelService.findById(pd);	//根据ID读取
		mv.setViewName("erp/level/level_edit");
	...
	public Object deleteAll() throws Exception{
		...
		if(null != DATA_IDS && !"".equals(DATA_IDS)){
			...
			levelService.deleteAll(ArrayDATA_IDS);
			pd.put("msg", "ok");
		}else{
			pd.put("msg", "no");
		}
	...
	public ModelAndView exportExcel() throws Exception{
		...
		List<PageData> varOList = levelService.listAll(pd);
