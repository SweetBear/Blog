...
<body class="no-skin">
	...
	<script type="text/javascript">
		...
		function erweima(GOODS_ID){
			 ...
			 diag.Drag=true;
			 diag.Title ="商品二维码";
			 diag.URL = '<%=basePath%>goods/erweima.do?GOODS_ID='+GOODS_ID+'&url='+url;
			 diag.Width = 283;
			 diag.Height = 276;
		...
		//商品条形码
		function barcode(GOODS_ID,BIANMA){
			 top.jzts();
			 var diag = new top.Dialog();
			 diag.Drag=true;
			 diag.Title ="商品条形码";
			 diag.URL = '<%=basePath%>goods/barcode.do?GOODS_ID='+GOODS_ID+'&BIANMA='+BIANMA;
			 diag.Width = 283;
			 diag.Height = 186;
			 diag.Modal = false;			//有无遮罩窗口
			 diag. ShowMaxButton = true;	//最大化按钮
